...
export default function App() {
  ...
  // ── View routing ─────────────────────────────────────────────
  const [view, setView]   = useState("dashboard");  // dashboard | assessment | results | carrier | admin
  ...
  return (
    <div style={{ background:C.bg, minHeight:"100vh" }}>
      ...
      {page===4 && canAccess(4) && <Page4 onNext={()=>setPage(5)} onBack={()=>setPage(3)} onDataChange={setMetricsData} />}
      {page===5 && canAccess(5) && (
        <Page5
